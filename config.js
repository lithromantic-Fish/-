// api调用域名
const apiUrl = 'https://zhaopin.hrloo.com';
...
module.exports = {
  ...
  // 这个在dist中不要出现, 有安全隐患
  // $appid: 'wx3f49a6726fbb5a6c',
  // $secret: '02d86c8e55ae621710e8ae30f5506e01',

  apiUrl: apiUrl,

  // 三茅招聘小程序静态资源存储位置
  staticUrl: 'http://static.hrloo.com/hrloo56/zpminiapp/img',
  ...
  ERR_MAPPING: {
    ...
    SHARE_NO_INPUT_PW: 303, //分享有密码但未通过密码验证进入简历页
    SHARE_CHANGE_PW: 304, // 分享密码已更改
    SHARE_RESUME_NONE: 401, // 简历不存在
    SESSION_KEY_EXPIRED: 999, // sessionKey过期
  },

  // 获取用户信息后存储在storage中的key值
  authorizationURL: '/pages/authorization/authorization',
